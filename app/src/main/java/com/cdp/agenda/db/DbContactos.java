...
public class DbContactos extends DbHelper {
    ...
    public long insertarContacto(String nombre, String telefono, String direccion, String correo_electronico) {
    ...
    public boolean editarContacto(int id, String nombre, String telefono, String direccion, String correo_electronico) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', telefono = '" + telefono + "', direccion = '" + direccion + "', correo_electronico = '" + correo_electronico + " ' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
